...
<script>
  ...
  gtag('config', 'UA-187426139-1');
    ...
    <title>iDotcommers - Privacy Policy</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="author" content="ThemeZaa">
    <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <meta name="description" content="in privacy policy section you will see Who we are, What personal data we collect and why we collect it">
    <link rel="canonical" href="https://www.idotcommers.com/privacy-policy/">
    <!-- favicon icon -->
...
<body data-mobile-nav-style="classic">
    ...
    <!-- end header -->
    <!-- start page title -->
    <section class="parallax" data-parallax-background-ratio="0.5" style="background-color: black;">
        <!--add mob1 class in this sction beside container -->
        <div class="container mob1">
            <div class="row align-items-stretch justify-content-center">
                <div class="col-12 page-title-large text-center d-flex align-items-center justify-content-center flex-column">
                    ...
                    <h1 class="alt-font text-white font-weight-500 no-margin-bottom" style="padding-top:50px;font-size:70px;">Privacy Policy</h1>
                </div>
            </div>
        </div>
    </section>

    <!--Mobile view for privacy policy header -->
    <section class="mobile-view" data-parallax-background-ratio="0.5" style="background-color: black;">

        <div class="container">
            <div class="row align-items-stretch justify-content-center">
                <div class="col-12 page-title-large text-center d-flex align-items-center justify-content-center flex-column">

                    <h1 class="alt-font text-white font-weight-500 no-margin-bottom webhead" style="padding-top:15px;font-size:70px;">Privacy Policy</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row" style="margin-left: 15px;margin-right:15px;">
                <div class="col-md-12" style="">
                    <h2>Who we are</h2>
                    <p>Our website address is:&nbsp;<a href="https://www.idotcommers.com/" target="_blank" rel="noreferrer noopener">www.idotcommers.com</a></p>
                    ...
                    <p>An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here:&nbsp;<a href="https://automattic.com/privacy/" target="_blank" rel="noreferrer noopener nofollow">automattic.com/privacy/</a>. After approval of your comment, your profile picture is visible to the public in the context of your comment.</p>
                    <h3>Media</h3>
                    ...
                    <p>If you leave a comment, the comment and its metadata are retained indefinitely. This is to recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.</p>
                    ...
                    <h5>What automated decision making and profiling we do with user data</h5>
