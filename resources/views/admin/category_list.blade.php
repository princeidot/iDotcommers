                    ...
                    <table id="order-listing" class="table">
                      ...
                      @foreach ($category as $list_category)
                        ...
                        <tr>
                            ...
                            <td>
                              <button class="btn btn-outline-primary"><a href="{{url('admin/category_edit/'.$list_category->id)}}">Edit</button>
                              <button class="btn btn-outline-danger"><a href="{{url('admin/category_delete/'.$list_category->id)}}" onclick="return confirm('Are you sure?')">Delete</button>
