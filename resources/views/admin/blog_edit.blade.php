  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <input type="hidden" value="{{session('data')['username']}}">
            <a class="nav-link" href="{{url('admin/dashboard1')}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{url('/admin/blog_list')}}">List Blogs</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{url('admin/blog_add')}}">Add Blog</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('admin/contacts')}}">
                ...
                <span class="menu-title">Contacts</span>
                           ...
                           <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#package-list" aria-expanded="false" aria-controls="editors">
              <i class="icon-loader menu-icon"></i>
              <span class="menu-title">Packages</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="package-list">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="{{url('admin/package')}}">List Package</a></li>
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{url('admin/blog_update/'.$blogs->id.'\/')}}" method="post" enctype="multipart/form-data" class="forms-sample">
                  @csrf
                  <div class="form-group">
                    <label for="exampleInputName1">Title</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Title" name="blog_title" value="{{old('title',$blogs->blog_title)}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">Category</label></br>
                    <select class="btn btn-outline-secondary dropdown-toggle " data-bs-toggle="dropdown" name="blog_category">Choose
                            <div class="dropdown-menu">
                            <a class="dropdown-item"><option name="blog_category">{{old('blog_category',$blogs->blog_category)}}</option></a>
                            @foreach($category as $cat )
                              <a class="dropdown-item"><option name="blog_category">{{ $cat->name }}</option></a>
                              @endforeach
                            </div>
                            </select>
                    {{-- <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter Author Name" name="author_name"> --}}
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">URL</label>
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter URL " name="url" value="{{old('url',$blogs->blog_url)}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">Tags</label>
                    <input type="text" class="form-control" id="tags" placeholder="Enter Tags" name="tags" value="{{old('tags',$blogs->tags)}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">Author Name </label></br>
                    <select class="btn btn-outline-secondary dropdown-toggle " data-bs-toggle="dropdown" name="author_name">Choose Author
                            <div class="dropdown-menu">
                              <a class="dropdown-item"><option name="author_name">{{old('author_name',$blogs->author_name)}}</option></a>
                            @foreach($author as $auth )
                              <a class="dropdown-item"><option name="author_name">{{ $auth->name }}</option></a>
                              @endforeach
                            </div>
                            </select>
                    {{-- <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter Author Name" name="author_name"> --}}
                  ...
                  <div class="form-group">
                    <label>Image</label>
                    <input type="file" name="image1" class="file-upload-default" value="{{old('/public/img/',$blogs->image1)}}">
                    <div class="input-group col-xs-12">
                      <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image" name="image1" value="{{old('/public/img/',$blogs->image1)}}">
...
<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="headdescription" placeholder="Enter Meta Description " name="headdescription" value="{{old('url',$blogs->description1)}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleTextarea1">Description</label>
                    <textarea class="form-control" id="summary-ckeditor" rows="4" name="summary-ckeditor" value="{{old('description',$blogs->description)}}">{{old('description',$blogs->description)}}</textarea>
                  </div>
  ...
  <script src="{{url('node_modules/ckfinder/ckfinder.js')}}"></script>
  <script>
   var edtior = CKEDITOR.replace('summary-ckeditor', {
      format_tags: 'p;h1;h2;h3;h4;h5;h6;pre;address;div',

    });
    CKFinder.setupCKEditor(edtior);
  </script>
