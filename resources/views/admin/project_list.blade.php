                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                      @foreach ($project as $list_projects)

                        <tr>
                            <td>{{ $list_projects->id }}</td>
                            <td>{{ $list_projects->project_type }}</td>
                            <td>{{ $list_projects->project_title }}</td>
                            <td><img src="{{ asset('/asset/website/'.$list_projects->image1) }}" alt=""></td>
                            <td><img src="{{ asset('/asset/website/'.$list_projects->image2) }}" alt=""></td>
                            {{-- <td>{{ $list_projects->description }} </td> --}}

                            <td>
                              <label class="badge badge-info">Live</label>
                            </td>
                            <td>
                              <button class="btn btn-outline-primary"><a href="{{url('admin/project_edit/'.$list_projects->id)}}">Edit</button>
                              <button class="btn btn-outline-danger"><a href="{{url('admin/project_delete/'.$list_projects->id)}}" onclick="return confirm('Are you sure?')">Delete</button>
