                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                      @foreach ($author as $list_author)

                        <tr>
                            <td>{{ $list_author->id }}</td>
                            <td>{{ $list_author->name }}</td>
                            ...
                            <td>
                              <button class="btn btn-outline-primary"><a href="{{url('admin/author_edit/'.$list_author->id)}}">Edit</button>
                              <button class="btn btn-outline-danger"><a href="{{url('admin/author_delete/'.$list_author->id)}}" onclick="return confirm('Are you sure?')">Delete</button>
