...
<head>
  ...
  <link rel="apple-touch-icon" sizes="114x114" href="{{url('asset/images/idot_short_white.png')}}">
  <!-- endinject -->
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{url('admin/save_project\/')}}" method="post" enctype="multipart/form-data" class="forms-sample">
                  @csrf
                  <div class="form-group">
                    <label for="exampleInputEmail3">Project Type </label></br>
                    <select class="btn btn-outline-secondary dropdown-toggle " data-bs-toggle="dropdown" name="project_type">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter Project Title" name="project_title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                      <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image 1" name="image1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                      <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image 2" name="image2">
                      <span class="input-group-append">
                        <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                      </span>
                    </div>
                  ...
                  <div class="form-group">
                      <label> Description
                    <textarea class="form-control" id="summary-ckeditor" rows="4"  name="summary-ckeditor"></textarea></label>
                  </div>
