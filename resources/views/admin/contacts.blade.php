                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                      @foreach ($contact as $list_cont)

                        <tr>
                            <td>{{ $list_cont->id }}</td>
                            <td>{{ $list_cont->name }}</td>
                            <td>{{ $list_cont->email }}</td>
                            <td>{{ $list_cont->number }}</td>
                            <td>{{ $list_cont->message }}</td>

                            <td>
                              <label class="badge badge-info">{{ $list_cont->created_at }}</label>
                            </td>
                            <td>
                              {{-- <button class="btn btn-outline-primary"><a href="{{url('/edit_contact/'.$list_cont->id)}}">Edit</button> --}}
                              <button class="btn btn-outline-primary"><a href="{{url('admin/delete_contact/'.$list_cont->id)}}" onclick="return confirm('Are you sure?')">Delete</button>
