          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{url('admin/author_update/'.$author->id.'\/')}}" method="post" enctype="multipart/form-data" class="forms-sample">
                  @csrf
                  <div class="form-group">
                    <label for="exampleInputName1">Author Name</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Author Name" name="name" value="{{old('name',$author->name)}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName1">Designation</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Designation" name="designation" value="{{old('desgination',$author->designation)}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName1">Description</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Description" name="description" value="{{old('description',$author->description)}}">
                  </div>
                  <div class="form-group">
                    <label>Image</label>
