          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{url('/admin/blog_list')}}" method="get" enctype="multipart/form-data" class="forms-sample">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter Category" name="blog_category" value="{{old('category',$blogs->blog_category)}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail3">Author Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter Author Name" name="author_name" value="{{old('author_name',$blogs->author_name)}}">
                  </div>
                  <div class="form-group">
                    <label>Image</label>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleTextarea1" rows="4" name="description" value="{{old('description',$blogs->description)}}">{{old('description',$blogs->description)}}</textarea>
                  </div>
                  <button type="submit" name="submit" class="btn btn-primary mr-2">BACK</button>
