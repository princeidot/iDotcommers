          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{url('/project_list')}}">List Projects</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{url('/project_add')}}">Add Project</a></li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="form-elements">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{url('/category_list')}}">List Categories</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{url('/category_add')}}">Add Category</a></li>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="editors">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{url('/author_list')}}">List Authors</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{url('/author_add')}}">Add Author</a></li>
                  </ul>
                </div>
              </li>
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{url('admin/project_update/'.$project->id.'\/')}}" method="post" enctype="multipart/form-data" class="forms-sample">
                  @csrf
                  <div class="form-group">
                    <label for="exampleInputEmail3">Project Type </label></br>
                    <select class="btn btn-outline-secondary dropdown-toggle " data-bs-toggle="dropdown" name="project_type" >Project List
                            <div class="dropdown-menu">
                             <a class="dropdown-item"><option name="author_name">{{old('project_type',$project->project_type)}}</option></a>
                            @foreach($category as $type)
                              <a class="dropdown-item"><option name="author_name">{{ $type->project_type}}</option></a>
                              @endforeach
                            </div>
                            </select>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail3">Project Title</label>
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter Project Title" name="project_title" value="{{old('project_title',$project->project_title)}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                      <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image 1" name="image1" value="{{old('asset/website/',$project->image1)}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                      <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image 2" name="image2" value="{{old('asset/website/',$project->image2)}}">
                      <span class="input-group-append">
                        <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                      </span>
                    </div>
                  ...
                  <div class="form-group">
                    <label> Description
                  <textarea class="form-control" id="summary-ckeditor" rows="4"  name="summary-ckeditor">{{old('description',$project->description)}}</textarea></label>
                </div>
