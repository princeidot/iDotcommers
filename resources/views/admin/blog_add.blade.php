...
<head>
  ...
  <link rel="shortcut icon" href="{{url('asset/images/idot_short_white.png')}}">
  <link rel="apple-touch-icon" href="{{url('asset/images/idot_short_white.png')}}">
  <link rel="apple-touch-icon" sizes="72x72" href="{{url('asset/images/idot_short_white.png')}}">
...
<li class="nav-item">
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{url('admin/save_blog\/')}}" method="post" enctype="multipart/form-data" class="forms-sample">
                  @csrf
                  <div class="form-group">
                    <label for="exampleInputName1">Title</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Title" name="blog_title">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter URL " name="url">
                  </div>
                  <div class="form-group">
 ...
 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="headdescription" placeholder="Enter Meta Description " name="headdescription">
                  </div>
                  <div class="form-group">
