...
<script>
    ...
    <title>Copywriter at idotcommers -{{$url}}</title>
    <meta charset="utf-8">
    ...
    $url_segment = explode('=', $actual_link);

    $url_last_segment = end($url_segment);
    if ($actual_link == $url_last_segment) {
        $url_last_segment = "page=1";
    } else {
        $url_last_segment = "page=" . $url_last_segment;
    }
    ?>
    <link rel="canonical" href="<?php echo $actual_link; ?>">

    <meta name="description" content="Take a look at all posts by <?php echo $cat; ?> on this page, he talks about digital marketing and all aspects of online marketing made easy. ">
    <!-- favicon icon -->
...
<body data-mobile-nav-style="classic">
    ...
    <!-- end header -->
    <!-- start page title -->
    <section class="half-section bg-light-gray parallax" data-parallax-background-ratio="0.5" style="padding:0px 0px!important;">
        <div class="container">
            <div class="row align-items-stretch justify-content-center extra-small-screen">
                <div class="col-12 col-xl-6 col-lg-7 col-md-8 page-title-extra-small text-center d-flex justify-content-center flex-column">
                    {{-- <h1 class="alt-font text-gradient-sky-blue-pink margin-15px-bottom d-inline-block">Posts by Author</h1> --}}
                    <h1 style="    font-size: 3.9rem;
    line-height: 4.2rem;" class="text-extra-dark-gray alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom">Posts by Author</h1>
                </div>
            </div>
        </div>
    </section>
    <!-- end page title -->
    <!-- start section -->
    <section class="bg-light-gray pt-0 padding-eleven-lr xl-padding-two-lr xs-no-padding-lr" style="margin-top:-90px;">
                ...
                <div class="col-12 blog-content">
                        ...
                        <li class="grid-item wow animate__fadeIn" data-wow-delay="0.2s">
                            <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                <div class="blog-post-image bg-medium-slate-blue">
                                    ...
                                    <a href="{{url('/'.$auth->blog_url)}}<?php echo '/'; ?>" title=""><img src="{{ asset('public/img/'.$auth->image1) }}" alt="{{$auth->image1}}" width="100" height="74"></a>
                                    <a href="{{url('blog/'.strtolower(str_replace(" ","-",$auth->blog_category)))}}<?php echo '/'; ?>" class="blog-category alt-font">{{ $auth->blog_category }}</a>
                                </div>
                                <div class="post-details padding-3-rem-lr padding-2-half-rem-tb">
                                    <a href="" class="alt-font text-small d-inline-block margin-10px-bottom">{{ $auth->created_at }}</a>
                                    <a href="{{url('/'.$auth->blog_url)}}<?php echo '/'; ?>" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray margin-15px-bottom d-block">{{ $auth->blog_title }}</a>

                                    <div class="d-flex align-items-center">

                                        <span class="alt-font text-small mr-auto">By <a href="" class="text-sky-blue-hover">{{ $auth->author_name }}</a></span>
                    ...
                    <div class="col-12 d-flex justify-content-center margin-7-half-rem-top md-margin-5-rem-top wow animate__fadeIn">
                        <ul class="pagination pagination-style-01 text-small font-weight-500 align-items-center">
                            ...
                            <li class="page-item">{{$author->links('pagination::bootstrap-4')}}</li>
