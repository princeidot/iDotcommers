        ...
        <div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
            <div class="row text-center text-sm-left" style="margin-right: -190px;">
                <div class="col-12 col-xl-5 col-lg-6 xs-margin-15px-bottom" style="flex: 0 0 54.667%; max-width: 45.667%;">
                    <img src="{{asset('public/img/'.$seme->image2)}}" style="border:5px solid black; padding:10px ">
                </div>
...
@else
 <li class="page-item">
        <a class="page-link" href="{{ url('sem',$previous) }}">
        <i class="feather icon-feather-arrow-left icon-extra-small d-xs-none"></i>  PREV
    </a>
</li>
...
@else
 <li class="page-item">
        <a class="page-link" href="{{ url('sem',$next) }}">
        Next<i class="feather icon-feather-arrow-right icon-extra-small d-xs-none"></i>  
    </a>
</li>
