...
<head>
    ...
    <title>SALES Dead LIST IDOTCOMMERS</title>
    <!-- plugins:css -->
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Dead Leads</h4>
                                        ...
                                        <table id="order-listing" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="myDIV">
                                                    ...
                                                    <td>
                                                        <a href=""><span class="ti-pencil-alt hide"></span></a>{{ $list_blogs->id }}
                                                    </td>
                                                    ...
                                                    <th>{{ ucwords(strtolower($list_blogs->leaduserby)) }}</th>
                                                 <th><a class="btn btn-outline-danger" href="{{url('sales/delete/'.$list_blogs->sleadid)}}">Delete</a></th>
                                                </tr>
