                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Lead</h4>
                                 <div class="row pb-5">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="">
                                            <p class="card-description font-weight-bolder text-body">
                                                Source : {{$username->leaduserby}}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">

                                        <button type="button" class="card-description font-weight-bolder mr-2 btn btn-primary text-white" data-toggle="modal" data-target="#exampleModal">
                                            Assign to Poojan
                                        </button>
                                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add Date and Comment</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <form action="{{url('sales/poojan')}}" method="post">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" value="{{$username->sleadid}}" name="leadid">
                                                        <div class="col-md-8">
                                                            <input type="datetime-local" class="button-13" id="pdate" name="pdate" style="padding: 3px 10px 3px 11px;width:150px;" required>
                                                            <br><br> <input type="text" class="form-control" placeholder="Enter Staus Comment" name="pcomment" required>
                                ...
                                <form action="{{url('sales/lead_updatestatus/'.$id)}}" method="post" enctype="multipart/form-data" class="forms-sample">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label for="exampleInputEmail3">Date</label></br>
                                               
                                            </div>
                                             <div class="col-md-2">
                                                <label for="exampleInputEmail3">Time</label></br>
                                               
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleInputEmail3">Status comment</label>
                                                <input type="text" class="form-control" placeholder="Enter Staus Comment" name="scomment" required>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="datetime-local" class="button-13" id="adate" name="adate" style="padding: 3px 10px 3px 11px;" required>
                                            </div>
                                            <div class="col-md-8">
                                                <label for="exampleInputEmail3">Action comment</label>
                                                <input type="text" class="form-control" placeholder="Enter Action Comment" name="acomment" required>
                                            </div>
                                            <div class=" col-md-12 statusbox mt-2">
                                                <div class="container">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <label for="exampleInputEmail3">Assign to Poojan</label>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label for="exampleInputEmail3">{{$assign->pdate}}</label>
                                                        </div>
                                                        <div class="col-md-7">
                                                            <label for="exampleInputEmail3">{{$assign->pcomment}}</label>
                                                        </div>
