...
<head>
    ...
    <title>Upcomming LIST IDOTCOMMERS</title>
    <!-- plugins:css -->
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">upcoming Leads</h4>
                            <div class="row">
                                <div class="col-12">
                                    <div class="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="myDIV">
                                                    ...
                                                    <td style="padding:0px;">
                                                                      <?php echo $date = date('d-m-Y', strtotime($list_blogs->adate)); ?>
                                                        </td>
                                                    <td>
                                                        <label class="badge badge-warning" style="width:4.2rem;"> <a href="{{url('sales/lead_editstatus/'.$list_blogs->leadid)}}"><span class="ti-pencil-alt-as hide"></span></a>{{ $list_blogs->aname }}</label>
