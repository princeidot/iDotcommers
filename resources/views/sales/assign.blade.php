...
<head>
    ...
    <title>Assign LIST IDOTCOMMERS</title>
    <!-- plugins:css -->
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="order-listing" class="table">
                                            ...
                                            <tbody>
                                                @foreach ($assgin as $list_blogs)

                                                <tr class="myDIV">

                                                    <td>
                                                        <a href="{{url('sales/lead_editstatus/'.$list_blogs->sleadid)}}"><span class="ti-pencil-alt hide"></span></a>{{ $list_blogs->id }}
                                                    </td>

                                                    <td>{{ $list_blogs->name }}</td>
                                                    <td>{{ $list_blogs->number }}</td>
                                                    <td>{{ $list_blogs->email }}</td>
                                                    <td>{{ $list_blogs->company }}</td>
                                                    <th>{{ $list_blogs->leaduserby }}</th>
                                                   
                                                    <th> 
                                                    <label class="badge badge-warning" style="width:4.2rem;"> <a href="{{url('sales/lead_editstatus/'.$list_blogs->sleadid)}}"><span class="ti-pencil-alt-as hide"></span></a>{{ $list_blogs->pcomment }}</label>
                                                    </th>
                                                </tr>
