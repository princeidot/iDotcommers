...
<!-- Mirrored from www.bootstrapdash.com/demo/skydash/template/demo/vertical-default-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jul 2021 09:38:04 GMT -->

<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <title>iDotcommers Sales Admin</title>
  <!-- plugins:css -->
...
<body>
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h3 class="font-weight-bold">Welcome {{$username->username}}</h3>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="{{url('asset/images/iDotcommersb.png')}}" alt="people">
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                      <a href="{{url('sales/today-leads')}}">
                    <div class="card-body">
                      <p class="mb-4 text-white">Today’s Follow Up</p>
                      <p class="fs-30 mb-2 text-white">{{$today}}</p>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  ...
                  <div class="card-body">
                      <p class="mb-4 text-white">Total Leads</p>
                      <p class="fs-30 mb-2 text-white">{{$alllead}}</p>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    ...
                    <div class="card-body">
                      <p class="mb-4 text-white">Total New Leads</p>
                      <p class="fs-30 mb-2 text-white">{{$tnew}}</p>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      <p class="mb-4">Total Warm Leads</p>
                      <p class="fs-30 mb-2">{{$twarm}}</p>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021. Premium <a href="https://www.idotcommers.com/" target="_blank">iDotcommers</a>All rights reserved.</span>
    ...
    <script src="{{url('jsadmin/dashboard1.js')}}"></script>
...
<!-- Mirrored from www.bootstrapdash.com/demo/skydash/template/demo/vertical-default-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jul 2021 09:38:27 GMT -->
