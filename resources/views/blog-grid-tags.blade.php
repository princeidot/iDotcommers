...
<script>
    ...
    $cat = str_replace(" ", "-", $url);
    ?>
    <link rel="canonical" href="https://www.idotcommers.com/tag/{{$cat}}/">
    <meta name="description" content="Read Interesting Articles About {{$cat}} By idotcommers Digital Marketing Agency ">
    <!-- favicon icon -->
        ...
        <div class="container">
            <div class="row align-items-stretch justify-content-center extra-small-screen">
                <div class="col-12 col-xl-6 col-lg-7 col-md-8 page-title-extra-small text-center d-flex justify-content-center flex-column">
                    <h1 class="alt-font text-gradient-sky-blue-pink margin-15px-bottom d-inline-block">TAG</h1>
                    <h2 class="text-extra-dark-gray alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom">{{$url}}</h2>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 blog-content">
                        ...
                        <li class="grid-item wow animate__fadeIn" data-wow-delay="0.2s">
                            <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                <div class="blog-post-image bg-medium-slate-blue">
                                    ...
                                    <a href="{{url('/'.$t->blog_url.'/')}}<?php echo '/'; ?>"><img src="{{ asset('public/img/'.$t->image1) }}" alt="{{$t->image1}}" width="100" height="74"></a>
                                    <a href="{{url('blog/'.strtolower(str_replace(" ","-",$t->blog_category)))}}<?php echo '/'; ?>" class="blog-category alt-font">{{ $t->blog_category }}</a>
                                </div>
                                <div class="post-details padding-3-rem-lr padding-2-half-rem-tb">
                                    <a href="#" class="alt-font text-small d-inline-block margin-10px-bottom">{{ $t->created_at }}</a>

                                    <a href="{{url('/'.$t->blog_url.'/')}}<?php echo '/'; ?>" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray margin-15px-bottom d-block">{{ $t->blog_title }}</a>

                                    <div class="d-flex align-items-center">
                                        {{-- <img class="avtar-image" src="{{url('asset/images/avtar34.jpg')}}" alt=""/> --}}
                                        <span class="alt-font text-small mr-auto">By <a href="" class="text-sky-blue-hover">{{ $t->author_name }}</a></span>
                    ...
                    <div class="col-12 d-flex justify-content-center margin-7-half-rem-top md-margin-5-rem-top wow animate__fadeIn">
                        <ul class="pagination pagination-style-01 text-small font-weight-500 align-items-center">
                            ...
                            <li class="page-item">{{$tags->links('pagination::bootstrap-4')}}</li>
