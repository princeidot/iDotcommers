...
<!-- Mirrored from lithohtml.themezaa.com/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jul 2021 06:44:27 GMT -->

<head>
    <base href="/">
    <title>iDotcommers - Rss-Feed</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="author" content="ThemeZaa">
    <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1" />
    <meta name="description" content="iDotcommers is a full-stack online marketing company in Navi Mumbai. We are one of the best digital marketing companies in Navi Mumbai">
    <link rel="canonical" href="https://www.idotcommers.com/about-us/">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-xl-8 col-lg-6">
                    <h1 class="alt-font text-extra-dark-gray font-weight-500 no-margin-bottom text-center text-lg-start">Rss Feed Blog</h1>
                </div>
                <div class="col-12 col-xl-4 col-lg-6 breadcrumb justify-content-center justify-content-lg-end text-small alt-font md-margin-10px-top">
                    <ul class="xs-text-center">
                        <li><a href="{{url('')}}">Home</a></li>
                        <li><a href="{{url('rss-feed')}}">Rss Feed</a></li>
                        <li>Rss Feed Blog</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div style="border:1px solid black;border-top:0px;">
                        <h5 style="background-color: #E9204F;height:48px;color:white;padding:4px;text-align: center;">Categories</h5>
                        <ul style="list-style:none;">
                            @foreach ($category as $cate)
                            <li style="text-align: center;">
                                <form action="{{route('rss-show')}}" method="post">
                                    @csrf
                                    <input type="hidden" value="{{ $cate->name }}" name="name">
                ...
                <div class="col-md-9" style="border: 1px solid black;padding-left: 0px;padding-right: 0px;">

                    <h1 class="title" style="background-color: #E9204F;height:48px;color:white;padding:4px;text-align: center;">List</h1>

                    <div class="">
                        <ul style="list-style:none;">
                            @foreach ($data as $title)
                            <li style="text-align: center;">
                                <a href="{{url('rss.xml/'.$title->id)}}"> {{$title->blog_title}}</a>
...
<!-- Mirrored from lithohtml.themezaa.com/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jul 2021 06:44:30 GMT -->
