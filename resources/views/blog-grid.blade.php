...
<script>
    ...
    <title>Digital Marketing Blogs related insights & tools for digital marketers | Idotcommers
</title>
    <meta charset="utf-8">
    ...
    <meta name="description" content="Digital marketing blog shared by Idotcommers provides core updates of a google search engine, tips & tricks of internet marketing. Follow our blogs to stay up to date on the latest digital trends!
<?php echo   $url_last_segment; ?>">
    ...
    <section class="half-section bg-light-gray parallax" data-parallax-background-ratio="0.5" style="background-image:url('images/portfolio-bg2.jpg');">
        <div class="container">
            <div class="row align-items-stretch justify-content-center extra-small-screen">
                  <div class="col-8 col-xl-8 col-lg-7 col-md-8 page-title-extra-small text-center mt-md-5 justify-content-center">
                    <h1 class="alt-font text-gradient-sky-blue-pink margin-15px-bottom d-inline-block">Our Knowledge Space</h1>
                ...
                <div class="col-4 col-xl-4 col-lg-5 col-md-4 page-title-extra-small text-center mt-md-5 justify-content-center">
                ...
                <div class="col-12 blog-content">
                        ...
                        <li class="grid-item wow animate__fadeIn" data-wow-delay="0.2s">
                            <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                <div class="blog-post-image bg-medium-slate-blue">
                                    ...
                                    <a href="{{url('/'.$blog->blog_url)}}<?php echo '/'; ?>">
                                        <img src="{{ asset('public/img/'.$blog->image1) }}" class="ff" width="100" height="74" alt="{{$blog->blog_url}}"></a>
                                    <a href="{{url('blog/'.strtolower(str_replace(" ","-",$blog->blog_category)))}}<?php echo '/'; ?>" class="blog-category alt-font">{{ $blog->blog_category }}</a>
                                </div>
                                <div class="post-details padding-3-rem-lr padding-2-half-rem-tb">
                                    <a href="" class="alt-font text-small d-inline-block margin-10px-bottom">{{ $blog->created_at }}</a>

                                    <a href="{{url('/'.$blog->blog_url)}}<?php echo '/'; ?>" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray margin-15px-bottom d-block">{{ $blog->blog_title }}</a>

                                    <div class="d-flex align-items-center">

                                        <span class="alt-font text-small mr-auto">By <a href="{{url('author/'.strtolower(str_replace(" ","-",$blog->author_name)))}}<?php echo '/'; ?>" class="text-sky-blue-hover">{{ $blog->author_name }}</a></span>
                    ...
                    <div class="col-12 d-flex justify-content-center margin-7-half-rem-top md-margin-5-rem-top wow animate__fadeIn">
                        <ul class="pagination pagination-style-01 text-small font-weight-500 align-items-center">
                            ...
                            <li class="page-item">{{$blogs->links('pagination::bootstrap-4')}}</li>
